...
namespace DotNetHelper.Database.Tests.Services.Providers.Impl
{
	public class SqlServerProvider : IDatabaseProvider
	{
		...
		public string GetConnectionString() =>  @"Server=(local)\SQL2017;Database=master;User ID=sa;Password=Password12!"; // "Server=(local)\\SQL2017;Initial Catalog=master;Integrated Security=False;User Id=sa;Password=Password12!";
#else
