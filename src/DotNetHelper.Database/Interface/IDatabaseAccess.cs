...
//{
//    public interface IDatabaseAccess<TDBConnection> where TDBConnection : DbConnection, IDisposable
//    {
...
//        /// <returns></returns>
//        TDBConnection GetNewConnection(bool openConnection);
...
//        /// <returns></returns>
//        DbCommand GetNewCommand(TDBConnection connection, string sql, CommandType commandType = CommandType.Text, IEnumerable<DbParameter> parameters = null);

//        (DbCommand command, DbTransaction transaction) GetNewCommandAndTransaction(TDBConnection connection);
