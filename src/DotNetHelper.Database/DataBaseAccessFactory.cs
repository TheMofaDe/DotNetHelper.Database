...
//    public class DatabaseAccessFactory : IDisposable 
//    {
...
//        public DatabaseAccessFactory(DataBaseType type)
//        {
//            SqlSyntaxHelper = new SqlSyntaxHelper(type);
//            ObjectToSql = new ObjectToSql.Services.ObjectToSql(type);
//        }
//        public DatabaseAccessFactory(DataBaseType type, string connectionString)
//        {
...
//            ObjectToSql = new ObjectToSql.Services.ObjectToSql(type);
//        }
//        public DatabaseAccessFactory(DataBaseType type, string connectionString, TimeSpan commandTimeOut)
//        {
//            if (string.IsNullOrEmpty(connectionString)) throw new NullReferenceException("invalid connection string");
//            ConnectionString = connectionString;
...
//            ObjectToSql = new ObjectToSql.Services.ObjectToSql(type);
//        }
//        public DatabaseAccessFactory(DataBaseType type, string connectionString, TimeSpan commandTimeOut, TimeSpan connectionTimeOut)
//        {
//            if (string.IsNullOrEmpty(connectionString)) throw new NullReferenceException("invalid connection string");
//            ConnectionString = connectionString;
//            CommandTimeOut = commandTimeOut;
